...
export async function launchChrome(): Promise<LaunchChromeResult> {
  ...
  // FirstTimeSetup_生成AI初回設定.bat で先にログインするよう案内して終了する。
  ...
  if (isFirstRun) {
    ...
    console.log('');
    console.log('  まず FirstTimeSetup_生成AI初回設定.bat を実行して');
    console.log('  各 AI サービスにログインしてください。');
    console.log('');
    console.log('  ログイン完了後、改めて BulkSearch_生成AI一括検索.bat を実行してください。');

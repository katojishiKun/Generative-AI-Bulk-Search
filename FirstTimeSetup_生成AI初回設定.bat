...
echo Run FirstTimeSetup_ê∂ê¨AIèââÒê›íË.bat once, login to each AI service,
echo then close Chrome. After that, use BulkSearch_ê∂ê¨AIàÍäáåüçı.bat.
echo.
...
echo After that, run BulkSearch_ê∂ê¨AIàÍäáåüçı.bat.
echo.